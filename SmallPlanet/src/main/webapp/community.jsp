    ...
    <%@page import="boardPack.BoardVO" %>
        <%@page import="java.util.Vector" %>
            ...
            <%@page import="userPack.UserVO" %>
                ...
                <% request.setCharacterEncoding("utf-8"); String user=(String)session.getAttribute("user"); UserVO
                    uVO=new UserVO(); String userName="" ; if(user!=null){ uVO=uDAO.getUser(user);
                    userName=uVO.getName(); } String boardName="community" ; int start=0; int end=10; int listSize=0;
...
=======
                    ...
                    <!DOCTYPE html>
                    <jsp lang="KO">
>>>>>>> 510330a920e76547b088ae7fabbde474a2259178
                            ...
                            <header style="z-index: 1;">
                                ...
                                <nav class="navbar">
                                    <div class="navbar_logo">
                                        <a style="color: #5180d8; border-bottom: 2px solid transparent;"
                                            href="index.jsp" class="navbar_logotext">SMALLPLANET</a>
                                    </div>
                                    ...
                                    <div class="menu">
                                        <ul class="navbar_menu">
                                            ...
                                            <li><a class="menuNum" href="community.jsp"
                                                    style="border-bottom: 2px solid #5180d8; padding-bottom: 42px;">커뮤니티</a>
                                            </li>
...
>>>>>>> 510330a920e76547b088ae7fabbde474a2259178
                            ...
                            <main>
                                ...
                                <table class="list-form">
                                    ...
                                    <tbody>
                                        <% vlist=bDAO.getBoardList(boardName,keyField,keySub,keyWord, start, end);
                                            listSize=vlist.size(); for(int i=0;i<10;i++){ if(i==listSize) break; BoardVO
                                            vo=vlist.get(i); int seq=vo.getSeq(); int ref=vo.getRef(); String
                                            subject=vo.getSubject(); String title=vo.getTitle(); String
                                            writer=vo.getWriter(); String uploadDate=vo.getUploadDate(); int
                                            cnt=vo.getCnt(); uVO=uDAO.getUser(writer); String writerName=uVO.getName();
                                            String w_authority=uVO.getAuthority(); %>
                                            <tr class="list-under-line">
                                                <td>
                                                    <%=seq %>
                                ...
                                <form name="searchFrm" method="post">
                                    ...
                                    <div style="display: flex; position: relative; top: 120px; right: -46px;">
                                        <select name="" id=""
                                            style="margin-right: 10px; border-radius: 10px; border: 1px solid #5180d8;">
                                            <option value="">모든 카테고리</option>
                                            <option value="test">test1</option>
                                            <option value="test2">test2</option>
                                            <option value="test3">test3</option>
                                        ...
                                        <select name="" id=""
                                            style="margin-right: 100px; border-radius: 10px; border: 1px solid #5180d8;">
                                            <option value="content">내용</option>
                                            <option value="title">제목</option>
                                            <option value="writer">작성자</option>
                                        </select>
                            ...
                            <footer class="foot-container">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <h6></h6>
                                            <p style="color: #5b5b5b;" class="text-justify">안녕하세요 Small planet 입니다.
                                        ...
                                        <div class="col-xs-6 col-md-3">
                                            ...
                                            <ul class="footer-links">
                                                <li><a
                                                        href="http://scanfcode.com/category/front-end-development/">menu1</a>
                                                </li>
                                                <li><a
                                                        href="http://scanfcode.com/category/back-end-development/">menu2</a>
                                                </li>
                                                <li><a
                                                        href="http://scanfcode.com/category/java-programming-language/">menu3</a>
                                                </li>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <p style="color: #5b5b5b;" class="copyright-text">Copyright &copy; 2022 All
                                                Rights Reserved by
