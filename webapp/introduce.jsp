...
<body class="introbody">
        ...
        <nav class="navbar">
            ...
            <div class="menu">
                <ul class="navbar_menu">
                    ...
                    <li><a class="menuNum" href="introduce.jsp" style="border-bottom: 2px solid #5180d8; padding-bottom: 42px;">소 개</a></li>
    ...
    <div id="fullpage" style="width: 100%; display: block;">
        ...
        <div class="fullsection full1" pageNum="1"><span><img src="./images/Untitled-1 copy.jpg" alt=""></span></div>
        <div class="fullsection full2" pageNum="2"
            style="background-image: url(./images/introimg3.jpg); background-size: 100%;"><span>
                <h1 class="intro-con2"><br>모든것은 작은것에 부터 시작됩니다</h1>
            </span></div>        
        <div class="fullsection full3" pageNum="3"
            style="background-image: url(./images/introimg2.jpg); background-size: 100%;"><span>Let me
                introduce our team!</span></div>
        <div class="fullsection full4" pageNum="5"><span><img class="intro-img" src="./images/saydabin.png" alt="">
        ...
        <div class="fullsection full5" pageNum="6"><span><img class="intro-img" src="./images/sayjungsoo.png">
        ...
        <div class="fullsection full6" pageNum="7"><span><img class="intro-img" src="./images/sayhaejin.png">
        ...
        <div class="fullsection full7" pageNum="8"
            style="background-image: url(./images/introimg4.jpg); background-size: 100%;"><span>THANK YOU!</span></div>
    </div>
