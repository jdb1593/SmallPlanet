<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <%@page import="userPack.UserVO" %>
        <% request.setCharacterEncoding("utf-8"); String user=(String)session.getAttribute("user"); UserVO uVO=new
            UserVO(); String userName="" ; String userEmail="" ; String userBirthday="" ; String userRegDate="" ;
            if(user!=null){ uVO=uDAO.getUser(user); userName=uVO.getName(); userEmail=uVO.getEmail();
            userBirthday=uVO.getBirthday(); userRegDate=uVO.getRegDate(); } %>
            <!DOCTYPE html>
            <html lang="KO">
                            ...
                            <div class="jumbotron" style="padding-top: 15px;">
                                <form name="memberUpdate" method="post" action="member_update.jsp">
                                    ...
                                    <div class="form-group">
                                        <label>이메일</label>
                                        <div class="form-control" style="background-color:#c0c0c0;">
                                            <%=userEmail%>
                                        </div>
                                        <div class="form-group">
                                            <label>비밀번호</label>
                                            <input id="password_1" type="password" class="form-control pw"
                                                placeholder="비밀번호" name="password" maxlength="20" value="">
                                            <input id="password_2" type="password" class="form-control pw"
                                                placeholder="비밀번호 확인" name="userPasswordCheck" maxlength="20" value="">
                                        </div>
                                        <!-- <input style=" width: 13%;text-align: center; display: flex;" type="submit"
                                class="btn btn-primary form-control" value="확인"> -->
                                        <div style="position: relative; text-align: right;">
                                            <div id="success" style="display:none; color: #000; font-size: 9px;">비밀번호가
                                                일치합니다.</div>
                                            <div id="danger"
                                                style="display:none; color: #d92742; font-weight: bold; font-size: 9px;">
                                                비밀번호가일치하지 않습니다.</div>
                                            <div id="password-danger" style="font-size:9px; color:red; display: none;">
                                                숫자+영문자+특수문자 조합으로 8자리 이상
                                                사용해야 합니다.</div>
                                            <div id="password-danger3" style="font-size:9px; color:red; display:none;">
                                                같은 문자를 4번 이상 사용 하실 수
                                                없습니다.</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <%-- <input type="text" class="form-control" placeholder="생년월일"
                                                name="birthday" maxlength="20" value="<%=userBirthday%>" readonly>
                                        </div> --%>
                                        <div class="form-control" style="background-color:#c0c0c0;">
                                            <%=userBirthday%>
                                        </div>
                                    ...
                                    <a href="./secession.jsp"></a><input
                                        style="margin-top: 5px; border: 1px solid #ff3232; background-color:#ff3232;"
                                        type="button" class="btn btn-primary form-control" value="회원탈퇴"></a>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <h6></h6>
                                <p style="color: #5b5b5b;" class="text-justify">안녕하세요 Small planet 입니다. <br>세상에 모든것들은 아주
                                    작은 것에서 비롯되어
                            ...
                            <div class="col-xs-6 col-md-3">
                                ...
                                <ul class="footer-links">
                                    ...
                                    <li><a href="http://scanfcode.com/category/java-programming-language/">menu3</a>
                                    </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <p style="color: #5b5b5b;" class="copyright-text">Copyright &copy; 2022 All Rights
                                    Reserved by
